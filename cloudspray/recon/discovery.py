...
from cloudspray.recon.dns_utils import identify_mail_provider
...
class ReconDiscovery:
    ...
    def run(self, reporter) -> ReconResult:
        ...
        provider, host = identify_mail_provider(self._domain)
        result.mail_provider = provider or None
        result.mail_host = host or None

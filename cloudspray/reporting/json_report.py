...
class JSONReporter:
    ...
    def generate(self, output_path: str, redact_passwords: bool = True) -> None:
        ...
        Args:
            ...
            redact_passwords: If True (default), replace passwords in the
                spray_log section with "[REDACTED]". Passwords in
                valid_credentials are always included.
        """
        ...
        report = {
            ...
            "spray_log": [
                {
                    "username": a.username,
                    "password": "[REDACTED]" if redact_passwords else a.password,

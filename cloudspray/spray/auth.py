...
class Authenticator:
    ...
    Args:
        domain: Target Azure AD tenant domain (e.g., ``example.com``).
    ...
    def attempt(self, username: str, password: str) -> SprayAttempt:
        ...
        Args:
            username: Full UPN to authenticate (e.g., ``user@example.com``).
        ...
        # replaced with the first label of the domain (e.g., "example" from
        # "example.com") to form a valid SharePoint URL.
